...
# 4 vcheck
#commented for testing
bash -i MuDoGeR/src/scripts/mudoger-module-3-4_vcheck.sh "$libname_folder"/viruses/investigation/dereplication/uvigs/uvigs_95-70.fna "$libname_folder"/viruses/vcheck_quality "$cores"
