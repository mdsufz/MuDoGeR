...
In this step, a selection of Prokaryotic Metagenome-Assembled Genomes takes place (Nayfach et al., 2020). **(2.b.1)** First, the Prokaryotic Metagenome-Assembled Genomes are grouped by taxonomy. **(2.b.2)** Furthermore, the produced cluster are separated by species using ANI (Average Nucleotide Identity) splitter with ANI_distance 95. Clusters with bootstrap > 75 are represent new species. **(2.b.3)** Finally, there is a selection of representative Metagenome-Assembled Genomes, from the clusters produced in **(2.b.2)**.
...
In this step a selection of Eukaryotic Metagenome-Assembled Genomes takes place. **(4.c.1)** First, the Eukaryotic Metagenome-Assembled Genomes are grouped by taxonomy using the results from **BUSCO** and **EukCC**. **(4.c.2)** Furthermore, the produced cluster are separated by species using ANI (Average Nucleotide Identity) splitter with ANI_distance 95. Clusters with bootstrap > 75 are represent new species. **(4.c.3)** Finally, there is a selection of representative Metagenome-Assembled Genomes, from the clusters produced in **(4.c.2)**.
