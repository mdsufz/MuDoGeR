...
In **3.b** the user can select viral representatives. **(3.b.1)** The viral representatives encompass all viruses that yielded taxonomy when using vContact2 plus those larger than XX Kb.
