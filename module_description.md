...
In **3.b** the user can select viral representatives.The viral representatives are those with high and medium quality. Those viral contigs are also dereplicated (minimum coverage of 70% and minimum identity of 95%).
...
* Crusoe, M. R. et al. The khmer software package: enabling efficient nucleotide sequence analysis. F1000Res 4, (2015).
