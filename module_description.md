...
Finally, **(3.b)** the user can select viral representatives. The viral representatives encompass all viruses that yielded taxonomy when using vContact2 plus those larger than XXKb.
