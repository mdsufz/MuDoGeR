...
### 2.b: Selection of Prokaryotic Metagenome-Assembled Genomes (special step only for  Prokaryotic Metagenome-Assembled Genomes)
In this step, a selection of Prokaryotic Metagenome-Assembled Genomes takes place. This selection should be done, as not all MAGs have refference genome in **GTDB-Tk** taxonomy database or they are not complete enough to be assigned for taxonomy. Because of that, it is not gauranteed that all the organisms belong to the same species or the same taxa that their assigned. As a result, a determination of species is performed, so the user can have one representative MAG per group. **(2.b.1)** First, the Prokaryotic Metagenome-Assembled Genomes are grouped by taxonomy. **(2.b.2)** Furthermore, the produced cluster are separated by species using ANI (Average Nucleotide Identity) splitter with ANI_distance 95. Clusters with bootstrap > 75 are represent new species. **(2.b.3)** Finally, there is a selection of representative Metagenome-Assembled Genomes, from the clusters produced in **(2.b.2)**.
...
### **3.b**: Selection of Viral Metagenome-Assembled Genomes and relative abundance (not done, after the meeting with rene)
...
In this step a selection of Eukaryotic Metagenome-Assembled Genomes takes place. In this step, a selection of Prokaryotic Metagenome-Assembled Genomes takes place.  **(4.c.1)** First, the Eukaryotic Metagenome-Assembled Genomes are grouped by taxonomy using the results from **BUSCO** and **EukCC**. **(4.c.2)** Furthermore, the produced cluster are separated by species using ANI (Average Nucleotide Identity) splitter with ANI_distance 95. Clusters with bootstrap > 75 are represent new species. **(4.c.3)** Finally, there is a selection of representative Metagenome-Assembled Genomes, from the clusters produced in **(4.c.2)**.
